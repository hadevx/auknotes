...
import { useGetFeaturedCoursesQuery } from "@/redux/queries/productApi";
...
export default function FeaturedCourses() {
  ...
  const { data: categories, isLoading: loadingCourses } = useGetFeaturedCoursesQuery();
  ...
  return (
    <section className="container mx-auto px-3 lg:px-8 py-16 lg:py-24">
      {loadingCourses ? (
        <Loader />
      ) : (
        <>
